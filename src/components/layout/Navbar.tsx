    ...
    <header className="h-16 flex items-center px-6 shrink-0 bg-transparent relative z-20">
      <div className="absolute inset-x-4 top-2 bottom-2 glass rounded-2xl flex items-center px-4">
        <button 
          ...
          className="md:hidden mr-4 p-2 text-slate-400 hover:text-white hover:bg-white/10 rounded-xl transition-colors"
        >
      ...
      <div className="ml-auto flex items-center gap-2 sm:gap-4">
        ...
        <button
          ...
          className="p-2 sm:p-2.5 text-slate-400 hover:text-white hover:bg-white/10 rounded-xl transition-all duration-200"
          title="Sign out"
        >
