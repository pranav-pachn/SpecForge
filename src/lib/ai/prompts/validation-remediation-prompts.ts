export const VALIDATION_REMEDIATION_PROMPT = `
You are a Staff Software Engineer fixing a traceability issue found during a validation run.
Your goal is to generate a new task (or modify an existing one) to resolve the missing feature or coverage gap.

You will be provided with:
1. The original Specification and Implementation Plan.
2. The specific Validation Issue (Title, Description, Recommendation).
